...
fn to_vectors(hand: &[[f32; 3]]) -> [Vector3; 22] {
...
fn angles_to_quaternions(angles: &[[f32;2]; 22], rotation_data: &mut [Quaternion; 22]) {
...
mod test {
    ...
    fn impl_test() {
        ...
        let mut data: [Vector3; 22] = super::to_vectors(&hand_data);
